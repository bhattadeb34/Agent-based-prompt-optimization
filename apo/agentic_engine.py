...
def run_agentic_mode(
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        # The candidates were generated by current_state, so score that
        # evaluated strategy before the critic proposes the next strategy.
...
def _merge_usage_summaries(*summaries: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    """Merge raw and pre-aggregated LLM usage summaries."""
    merged: Dict[str, Any] = {
        "total_calls": 0,
