...
def run_agentic_mode(
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        # Critic scores the strategy that generated this epoch's candidates.
        ...
        epoch_usage = _merge_usage_summaries(epoch_usage, critic_usage or {})
    ...
    for usage_summary in usage_summaries:
        total_usage = _merge_usage_summaries(total_usage, usage_summary)
...
def _merge_usage_summaries(base: Dict[str, Any], extra: Dict[str, Any]) -> Dict[str, Any]:
    ...
    merged["total_latency_s"] = round(
        merged.get("total_latency_s", 0.0) + extra.get("total_latency_s", 0.0),
        3,
    )
