...
def _merge_usage_summaries(*summaries: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    """Merge aggregate_usage-style dictionaries from multiple agents."""
    merged: Dict[str, Any] = {
        "total_calls": 0,
...
def run_agentic_mode(
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        # Log epoch
        # Worker returns raw LLMUsage objects; critic/meta return aggregate dicts.
        epoch_usage = _merge_usage_summaries(worker_usage, critic_usage)
        usage_summaries.append(epoch_usage)
    ...
    total_usage = _merge_usage_summaries(*usage_summaries)
