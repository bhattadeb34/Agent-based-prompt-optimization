...
def _merge_usage_summaries(*summaries: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    """Merge aggregate_usage()-style dicts without mixing them with LLMUsage objects."""
    merged: Dict[str, Any] = {
        "total_calls": 0,
...
def run_agentic_mode(
    ...
    total_usage = _merge_usage_summaries(aggregate_usage(all_usages), *aggregate_usage_summaries)
