...
def run_agentic_mode(
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        usage_summaries.append(worker_usage_summary)
        ...
        current_state.score = reward_fn.compute(valid_candidates)
...
def _merge_usage_summaries(usages: List[Optional[Dict[str, Any]]]) -> Dict[str, Any]:
    """Merge aggregate_usage() dictionaries emitted by agentic sub-agents."""
    merged: Dict[str, Any] = {
        "total_calls": 0,
