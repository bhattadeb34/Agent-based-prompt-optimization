...
"""
    ...
    def _validate_candidates(self, candidates_raw: List[Dict]) -> List[Dict]:
        """Validate candidates using the same task semantics as the non-agentic loop."""
        validated = []
        for cand in candidates_raw:
            ...
            child_key = canonicalize(child_smiles)
            ...
            try:
                child_value = self.surrogate.predict_single(child_key)
