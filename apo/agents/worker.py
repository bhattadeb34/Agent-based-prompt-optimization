...
"""
        ...
        try:
            ...
            if isinstance(generated, dict):
                for parent, parent_data in generated.items():
                    smiles_list = parent_data.get("smiles", [])
                    reasoning_list = parent_data.get("reasoning", [""] * len(smiles_list))
